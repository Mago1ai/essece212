    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          {/* Manifesto Text (Centered) */}
          <div className="lg:col-span-12 flex flex-col items-center text-center space-y-8 max-w-3xl mx-auto">
            <div>
              {/* Label */}
              ...
              {/* Poetic Paragraph */}
              <p className="font-sans-clean text-lg sm:text-xl md:text-2xl text-[#EAE3D9]/90 font-light leading-[1.7] max-w-xl mx-auto mb-8">
            ...
            <div className="pt-8 border-t border-white/15 grid grid-cols-2 gap-6 font-mono-subtle text-xs text-[#EAE3D9]/60 w-full">
              <div>
