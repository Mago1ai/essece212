...
export const HouseSection: React.FC<HouseSectionProps> = ({ onOpenStoryModal }) => {
  return (
    <section
      id="casa"
      className="relative w-full bg-[#F4F0E9] dark:bg-[#161513] text-[#24221F] dark:text-[#F5F2EB] py-24 sm:py-32 md:py-36 border-b border-[#24221F]/8 dark:border-white/10 transition-colors duration-500"
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="xl:col-span-5 flex flex-col justify-center space-y-6 sm:space-y-8">
            ...
            <p className="font-sans-clean text-base sm:text-lg lg:text-xl text-[#24221F]/80 dark:text-[#F5F2EB]/80 font-light leading-[1.75] max-w-lg">
          ...
          <div className="xl:col-span-7 relative">
             <div className="aspect-[4/3] w-full overflow-hidden bg-[#EAE3D9] dark:bg-[#121110] border border-[#24221F]/8 dark:border-white/10">
               <img 
                 src="/images/house-couple.jpg" 
                 alt="Casal elegante representando a presença da Máximo Eau de Parfum"
        ...
        {/* Quiet Detail Strip */}
        <div className="mt-16 sm:mt-24 pt-8 border-t border-[#24221F]/10 dark:border-white/10 grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 text-[#24221F]/70 dark:text-[#F5F2EB]/70 font-mono-subtle text-xs">
          <div>
